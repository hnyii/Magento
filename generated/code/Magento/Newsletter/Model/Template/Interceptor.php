...
class Interceptor extends \Magento\Newsletter\Model\Template implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTemplateText');
        return $pluginInfo ? $this->___callPlugins('getTemplateText', func_get_args(), $pluginInfo) : parent::getTemplateText();
    }
